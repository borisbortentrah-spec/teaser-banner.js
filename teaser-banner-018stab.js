      ...
      for (let i = 0; i < slotsCount; i++) {
        ...
        function loadTag() {
          ...
          script.text = `(function(d){
            ...
            wrapper.onload=function(){console.log("[TEASER] ✅ Wrapper завантажився aid=${aids[i]}");};
            wrapper.onerror=function(e){console.error("[TEASER] ❌ Помилка wrapper aid=${aids[i]}", e);};
